 ...
 */
@Configuration
@EnableR2dbcRepositories(basePackages = {"com.example.graalvm.repository.two"}, entityOperationsRef = "twoR2dbcEntityTemplate")
public class TwoR2dbcDatasourceConfig {
